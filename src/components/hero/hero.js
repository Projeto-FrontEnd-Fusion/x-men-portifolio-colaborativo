...
const Hero = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("header", { className: "flex w-full ", children: _jsx("div", { className: "flex lg:justify-center py-8 w-full bg-[#2B3A4F]", children: _jsxs("div", { className: "flex justify-around items-center lg:w-4/5", children: [_jsx("img", { src: Logo, alt: "Tech Logo", className: "h-16 ml-4" }), _jsx(ButtonPrimary, { onClick: openModal, children: "Fa\u00E7a Parte" })] }) }) }), _jsxs("main", { className: "flex w-full", children: [_jsxs("div", { className: "flex flex-col items-start justify-center px-8 sm:px-16 lg:px-96 py-20 space-y-16", children: [_jsx("div", { className: "absolute top-0 -left-16 w-1/3 h-1/3 bg-[radial-gradient(40.64%_40.64%_at_50.08%_52.49%,_rgba(40,_238,_237,_0.25)_0%,_rgba(0,_0,_0,_0)_100%)] blur-lg pointer-events-none" }), _jsxs("h1", { className: "text-[#EEEEEE] text-3xl sm:text-5xl font-semibold leading-tight text-left max-w-2xl lg: py-20 px-2 space-y-16 ", style: {
                                    ...
                                    textUnderlinePosition: "from-font",
                                        ...
                                        } })] }), _jsx("section", { className: "flex justify-center lg:justify-end items-center w-full", children: _jsx("img", { src: Tech, alt: "Tecnologias", className: "h-12 sm:h-16 lg:h-20" }) }), _jsx("footer", { className: "flex justify-items-start w-auto", children: _jsx("button", { children: _jsx("img", { src: Explorar, alt: "Bot\u00E3o explorar", style: {
                                            width: "auto",
                                            height: "32px",
                                            textUnderlinePosition: "from-font",
                                            textDecorationSkipInk: "none",
