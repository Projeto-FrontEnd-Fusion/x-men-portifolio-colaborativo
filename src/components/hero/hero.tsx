    ...
    return (
        <>
            ...
            <main className="flex w-full">
                <div className="flex flex-col items-start justify-center px-8 sm:px-16 lg:px-48 xxl:px-96 py-20 space-y-16">
                    ...
                    <section className="flex flex-col lg:flex-row items-center lg:justify-between w-full space-y-8 lg:space-y-0 lg:space-x-12 xxl:space-x-96">
                    ...
                    <section className="flex justify-center lg:justify-end items-center w-full">
                        <img
                            src={Tech}
                            alt="Tecnologias"
                            className="h-12 sm:h-10 lg:h-20 xxl:h-24"
                        />
                    </section>
